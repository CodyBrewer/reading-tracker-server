  ...
  knex('reading_lists')
    ...
    .then(() =>
      ...
      knex('reading_lists').insert([
        ...
        { user_id: '1e4d861c-d301-4318-9fd6-96ccbec9f821', name: 'read', public: false },
        { user_id: '1e4d861c-d301-4318-9fd6-96ccbec9f821', name: 'to-read', public: false },
        { user_id: '1e4d861c-d301-4318-9fd6-96ccbec9f821', name: 'reading', public: false }
      ])
    )
